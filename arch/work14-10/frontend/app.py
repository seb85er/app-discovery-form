...
def add_application():
    ...
    print(type(form.app_stakeholders))  # This will print the type of form.app_stakeholders
    print(form.app_stakeholders)  # This will print the value of form.app_stakeholders
