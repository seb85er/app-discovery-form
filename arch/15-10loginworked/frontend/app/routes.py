...
from app.forms import AppDiscoveryForm, LoginForm  # Imports classes from forms.py
...
def login():
    ...
    if request.method == 'POST' and form.validate_on_submit():
        ...
        if login_user(username, password):  # Assuming login_user handles authentication
