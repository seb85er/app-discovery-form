            ...
            for row in csv_reader:
                ...
                while True:
                    ...
                    if any(key.startswith(server_prefix) for key in row.keys()):
                        ...
                        if any(value for value in server_info.values()):
                ...
                while True:
                    ...
                    if any(key.startswith(interface_prefix) for key in row.keys()):
                        interface_info = {
                            ...
                            "other_system_owner": row.get(f"{interface_prefix}other_system_owner", ""),
                            "csrf_token": None
                        }
                        if any(value for value in interface_info.values()):
                ...
                # Include other sections like web_system, database, performance
