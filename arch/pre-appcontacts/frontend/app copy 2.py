        ...
        if csv_reader.fieldnames:
            ...
            for row in csv_reader:
                ...
                app_data = {
                    ...
                    # Add more mappings for 'interfaces', 'web_system', 'database', etc.
                }

                # Log the mapped data before inserting to Cosmos DB
                app.logger.info(f"Mapped Application Data: {app_data}")

                # Insert into Cosmos DB using the container client
                container.create_item(app_data)
